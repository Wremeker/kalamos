...
export const BulletedBlock: React.FC<BlockRendererProps> = ({
  block,
  baseClasses,
  contentProps,
}) => {
  ...
  return (
    <div role="listitem" className="flex items-start w-full max-w-full">
      <span className="text-gray-600 dark:text-gray-400 select-none mt-0.5 text-xl font-bold pr-2 flex-shrink-0">
        •
      </span>
