...
interface ToggleListBlockProps extends BlockRendererProps {
    ...
    <div className="toggle-list-block">
      <div className="flex items-start gap-1.5">
        <button
          ...
          className="flex-shrink-0 p-0.5 hover:bg-gray-100 dark:hover:bg-gray-800 rounded transition-colors mt-0.5"
        ...
        <div
          ...
          className={`${baseClasses} text-black dark:text-gray-100 font-bold flex-1 min-w-0 text-lg`}
        />
      </div>
